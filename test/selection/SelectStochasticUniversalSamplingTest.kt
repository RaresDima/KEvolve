...
class SelectStochasticUniversalSamplingTest {
    ...
    @Test
    fun initialize() { SelectStochasticUniversalSampling<MyIndividual>() }
    ...
    fun `select correct num`(size: Int) {
        ...
        val select = SelectStochasticUniversalSampling<MyIndividual>()
